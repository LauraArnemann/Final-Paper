...
\begin{figure}[h!]
    ...
    \end{center}
    \tiny
   \tablenotes{We display the average marginal effect of estimating our model by binary logit. The displayed effect is the effect of reporting to be the national of a program country.Question 3: Who was the driving force behind signing the memorandum; Question 4: Who was the main beneficiary of the program}
\end{figure}
%\begin{figure}[h!]
 %   \begin{center}
...
\begin{figure}[h!]
    ...
    \end{center}
    \tiny
   \tablenotes{We display the average marginal effect of estimating our model by binary logit. The displayed effect is the effect of reporting to be the national of a program country. The exact wording of the questions are the following. Question 5.4: The rescue experience made many citizens in the lender countries feel exploited; Question 5.5 The rescue experience made many citizens in the lender countries feel disappointed Question 5.6: The rescue experience strengthened friendships between citizens}
\end{figure}
\begin{figure}[h!]
    \begin{center}
     \caption{Who initiated and benefited from the rescue program  }
...
\begin{figure}[h!]
    \begin{center}
     \caption{Sentiments of borrower countries}
...
\begin{figure}[h!]
    \begin{center}
     \caption{Sentiments of lender countries}
